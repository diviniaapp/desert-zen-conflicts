...
export function AudioPlayerControls({ audioUri, title }: AudioPlayerControlsProps) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.controlsContainer}>
        <TouchableOpacity
          ...
          disabled={isLoading}
        >
          <SkipBack color={isLoading ? theme.textTertiary : theme.textSecondary} size={28} />
        </TouchableOpacity>
        ...
        >
          {isLoading ? (
            ...
            <Pause color={theme.card} size={28} />
          ) : (
            <Play color={theme.card} size={28} />
          )}
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          disabled={isLoading}
        >
          <SkipForward color={isLoading ? theme.textTertiary : theme.textSecondary} size={28} />
        </TouchableOpacity>
      </View>
    </View>
  );
